<?php
	...
	function getBattleTowerPlaceholderTrainerForRegion($region, $level, $number) {
		if ($level == 0){
			switch ($region) {
				...
				case "e":
				case "p":
				case "u": return getBattleTowerPlaceholderTrainerEN($number);
		...
		if ($level == 1){
			switch ($region) {
				...
				case "e":
				case "p":
				case "u": return getBattleTowerPlaceholderTrainerEN1($number);
		...
		if ($level == 2){
			switch ($region) {
				...
				case "e":
				case "p":
				case "u": return getBattleTowerPlaceholderTrainerEN2($number);
		...
		if ($level == 3){
			switch ($region) {
				...
				case "e":
				case "p":
				case "u": return getBattleTowerPlaceholderTrainerEN3($number);
		...
		if ($level == 4){
			switch ($region) {
				...
				case "e":
				case "p":
				case "u": return getBattleTowerPlaceholderTrainerEN4($number);
		...
		if ($level == 5){
			switch ($region) {
				...
				case "e":
				case "p":
				case "u": return getBattleTowerPlaceholderTrainerEN5($number);
		...
		if ($level == 6){
			switch ($region) {
				...
				case "e":
				case "p":
				case "u": return getBattleTowerPlaceholderTrainerEN6($number);
		...
		if ($level == 7){
			switch ($region) {
				...
				case "e":
				case "p":
				case "u": return getBattleTowerPlaceholderTrainerEN7($number);
		...
		if ($level == 8){
			switch ($region) {
				...
				case "e":
				case "p":
				case "u": return getBattleTowerPlaceholderTrainerEN8($number);
		...
		if ($level == 9){
			switch ($region) {
				...
				case "e":
				case "p":
				case "u": return getBattleTowerPlaceholderTrainerEN9($number);
	...
	function getBattleTowerPlaceholderTrainerFR($number) {
		...
		$placeholderTrainer0[5]["pokemon3"] = hex2bin("DE8C395E69F600000003E89C407530821475307530FEFD0F0A1405640000000A0000002600260017001D00130018001C828E9180988E8D50505050");
		...
		$placeholderTrainer0[4]["pokemon3"] = hex2bin("836D3B39555E00000003E875307530753075307530FDEB050F0F0A640000000A000000340034001D001B0018001C001E8B8E8A878B809292505050");
		...
		$placeholderTrainer0[0]["class"] = hexdec("16");
		$placeholderTrainer0[0]["pokemon1"] = hex2bin("C9ADED00000000000003E875307530753075307530FFFF0F000000000000000A000000240024001A00150015001A00159980918188505050505050");
		$placeholderTrainer0[0]["pokemon2"] = hex2bin("80521DCF27C400000003E87530753075307530753065570F0F1E0F000000000A000000280028001E001D002000120018938094918E925050505050");
	...
	function getBattleTowerPlaceholderTrainerFR2($number) {
		...
		$placeholderTrainer2[4]["pokemon1"] = hex2bin("F2925C7387B60000006978C3507530AFC87530AFC8FBED0A140A0A640000001E000000D900D900200021003B0049006D818B889292849850505050");
		$placeholderTrainer2[4]["pokemon2"] = hex2bin("E58A35F2F78A0000006978AFC8C350C350AFC8AFC8FDED0F0F0F0F640000001E0000006C006C0054003B0056005E004C878E948D838E8E8C505050");
		$placeholderTrainer2[4]["pokemon3"] = hex2bin("446DEE08597E0000006978AFC8C3509C40C350AFC8FDBE050F0A05640000001E000000760076006C004B003D004400508C80828A8E868D84949150");
		...
		$placeholderTrainer2[3]["pokemon2"] = hex2bin("E9035E693FA10000006978D6D875309C40D6D87530DFDB0A14050A640000001E000000750075004900530042005700518F8E9198868E8DF8505050");
		$placeholderTrainer2[3]["pokemon3"] = hex2bin("697659D83F9B0000006978AFC8C350AFC8C3507530DDEB0A14050AFF0000001E000000630063004D005E0038003600488E92928093948494915050");
		...
		$placeholderTrainer2[2]["class"] = hexdec("26");
		$placeholderTrainer2[2]["pokemon1"] = hex2bin("65037155B65700000069789C40AFC89C40AFC8C350BDEF1E0F0A0A640000001E000000620062003900450071004E004E848B848293918E83845050");
		$placeholderTrainer2[2]["pokemon2"] = hex2bin("8392F037C4460000006978C350AFC888B8C3507530FDEB05190F0F640000001E0000008E008E0050004A0041004B00518B8E8A878B809292505050");
		$placeholderTrainer2[2]["pokemon3"] = hex2bin("ABAEF05739AF0000006978C3509C40C35075307530DDEB050A0F0F640000001E0000008B008B003E00400042004600468B808D9394918D50505050");
	...
	function getBattleTowerPlaceholderTrainerFR3($number) {
		...
		$placeholderTrainer3[6]["class"] = hexdec("20");
		$placeholderTrainer3[6]["pokemon1"] = hex2bin("80AED83F59E7000000FA00C350C350C350C350C350FDFE14050A0FFF000000280000008F008F00770071007F0046005E938094918E925050505050");
		$placeholderTrainer3[6]["pokemon2"] = hex2bin("E69239E13F3B000000FA00C350C350C350C350C350FDEF0F14050564000000280000008E008E00730071006A0073007387988F8E918E8850505050");
		...
		$placeholderTrainer3[5]["class"] = hexdec("1D");
		$placeholderTrainer3[5]["pokemon1"] = hex2bin("8392553A6D39000000FA00C350C350C350C350C350FDEB0F0A0A0F6400000028000000BA00BA006B006500560067006F8B8E8A878B809292505050");
		$placeholderTrainer3[5]["pokemon2"] = hex2bin("D0AEC9E7595C000000FA00C350C350C350C350C350EFDB0A0F0A0A6400000028000000890089006A00C7003D004F0057929384848B889750505050");
		$placeholderTrainer3[5]["pokemon3"] = hex2bin("41525E096907000000FA00C350AFC8C350D6D8C350DDEF0A0F140F64000000280000007E007E004C004900870093006B808B808A8099808C505050");
		...
		$placeholderTrainer3[4]["pokemon2"] = hex2bin("CAAE44F3DBC2000000FA00AFC8C350C350C350C350BFE7141419056400000028000000E900E9003E00550040003B004F968E818194858584935050");
		$placeholderTrainer3[4]["pokemon3"] = hex2bin("4C779959059D000000FA00AFC8C3509C40C350AFC8DDED050A140A6400000028000000910091007D008B004A0050005886918E8B848C5050505050");
	...
	function getBattleTowerPlaceholderTrainerFR4($number) {
		...
		$placeholderTrainer4[5]["class"] = hexdec("14");
		$placeholderTrainer4[5]["pokemon1"] = hex2bin("8F923F5939F4000001E848EA60D6D8D6D8EA60D6D8FDEF050A0F0A0000000032000001070107009F0070004F0072009F918E8D858B849750505050");
		...
		$placeholderTrainer4[5]["pokemon3"] = hex2bin("87525556F7ED000001E848D6D8EA60DEA8D6D8D6D8EDFF0F140F0F0000000032000000A100A10072006B00B3009F0090958E8B93808B8850505050");
		...
		$placeholderTrainer4[4]["pokemon2"] = hex2bin("C7549C395E85000001E848C3509C40AFC8C350C350DFDE0A0F0A140F00000032000000C400C40076007E004B0092009C918E888680838050505050");
		...
		$placeholderTrainer4[2]["pokemon3"] = hex2bin("916D4155563F000001E848AFC8C350AFC89C40C350FDDE140F14050000000032000000BE00BE00890081008F00AB0088848B848293878E91505050");
	...
	function getBattleTowerPlaceholderTrainerFR5($number) {
		...
		$placeholderTrainer5[6]["pokemon2"] = hex2bin("F8AEF2599D3F0000034BC0D6D8EA60D6D8EA60D6D8FDED0F0A0A05640000003C000000F000F000DC00BB008300A900AF939891808D8E8288855050");
		$placeholderTrainer5[6]["pokemon3"] = hex2bin("E56D35F28A9C0000034BC0EA60D6D8D6D8EA60D6D8FBEF0F0F0F0A640000003C000000D400D400A5007100AC00BD0099878E948D838E8E8C505050");
		...
		$placeholderTrainer5[5]["class"] = hexdec("38");
		$placeholderTrainer5[5]["pokemon1"] = hex2bin("E9923B695C5E0000034BC0D6D8C350C350C350D6D8DDDE05140A0A640000003C000000DF00DF009500A1007D00B600AA8F8E9198868E8DF8505050");
		$placeholderTrainer5[5]["pokemon2"] = hex2bin("444907EE09590000034BC0C350C350AFC8C350C350FDEF0F050F0A640000003C000000E200E200D4009400780086009E8C80828A8E868D84949150");
		...
		$placeholderTrainer5[3]["class"] = hexdec("25");
		$placeholderTrainer5[3]["pokemon1"] = hex2bin("C5AEBDEC5EB90000034BC0C350C350C350C350C350FDEF0A050A14640000003C000000E800E8008600B90084008000D48D8E8293808B8850505050");
		$placeholderTrainer5[3]["pokemon2"] = hex2bin("3B8A35F2F5E70000034BC0D6D8C3509C40D6D8C350FDED0F0F050F640000003C000000E400E400BC009200AA00AD0095809182808D888D50505050");
	...
	function getBattleTowerPlaceholderTrainerFR6($number) {
		...
		$placeholderTrainer6[6]["class"] = hexdec("19");
		$placeholderTrainer6[6]["pokemon1"] = hex2bin("876D553FF72E0000053BD8EA60DAC0D6D8C350EA60FBEF0F050F146400000046000000E700E7009E009100F500DE00C9958E8B93808B8850505050");
		...
		$placeholderTrainer6[3]["class"] = hexdec("1E");
		$placeholderTrainer6[3]["pokemon1"] = hex2bin("C5AEECB95EF70000053BD8C350C350AFC8AFC8C350FDEB05140A0F64000000460000010D010D009B00D60098008E00F08D8E8293808B8850505050");
		...
		$placeholderTrainer6[3]["pokemon3"] = hex2bin("C36D5939BCE70000053BD8C350C350AFC8C350C350DEDD0A0F0A0F64000000460000010A010A00B400B4006E009800988C80918088929384505050");
		...
		$placeholderTrainer6[2]["pokemon3"] = hex2bin("3949EE08099D0000053BD8C3509C40C350C350C350BDEF050F0F0A6400000046000000E300E300CA009100C4009400A2828E8B8E9292888D868450");
	...
	function getBattleTowerPlaceholderTrainerFR7($number) {
		...
		$placeholderTrainer7[6]["class"] = hexdec("32");
		$placeholderTrainer7[6]["pokemon1"] = hex2bin("876D5655E72E000007D000EA60D6D8EA60D6D8D6D8FDEB140F0F14640000005000000107010700B300AA011900F500DD958E8B93808B8850505050");
		...
		$placeholderTrainer7[4]["class"] = hexdec("1C");
		$placeholderTrainer7[4]["pokemon1"] = hex2bin("5E0055F76DA8000007D000C350C350AFC8D6D8C350DEDD0F0F0A0A6400000050000000F700F700AD00A500F8011500BD8482938E8F8B80928C8050");
		$placeholderTrainer7[4]["pokemon2"] = hex2bin("CD92995C4CCF000007D000AFC8C350C350AFC8C350FDED050A0A0F640000005000000111011100D90125008500A500A5858E919184939184929250");
		...
		$placeholderTrainer7[2]["pokemon2"] = hex2bin("E349D313BD5C000007D000C350AFC888B8C350C350DDEF190F0A0A640000005000000102010200C4011E00B7008900B98088918C94918450505050");
	...
	function getBattleTowerPlaceholderTrainerFR8($number) {
		...
		$placeholderTrainer8[6]["class"] = hexdec("41");
		$placeholderTrainer8[6]["pokemon1"] = hex2bin("C552B9BDEC6D00000B1FA8EA60EA60D6D8EA60D6D8FDED140A050A640000005A0000015D015D00CB011600CA00BC013A8D8E8293808B8850505050");
		$placeholderTrainer8[6]["pokemon2"] = hex2bin("95497E3FC83B00000B1FA8FDE8C350DAC0EA60EA60FDED05050F05640000005A000001570157014200FC00E501070107839180828E8B8E92928450");
		...
		$placeholderTrainer8[4]["class"] = hexdec("17");
		$placeholderTrainer8[4]["pokemon1"] = hex2bin("E692E1393F3B00000B1FA8C350C350D6D8C350AFC8DFDE140F0505640000005A00000135013500F800FF00E600F800F887988F8E918E8850505050");
		$placeholderTrainer8[4]["pokemon2"] = hex2bin("F8493FF2599D00000B1FA8C350D6D8C350AFC8C350DFDE050F0A0A640000005A0000016201620141011700B900FA0103939891808D8E8288855050");
		$placeholderTrainer8[4]["pokemon3"] = hex2bin("83549C39555E00000B1FA8AFC8C350C350C350D6D8BDEF0A0F0F0A640000005A00000195019500E300DD00BB00ED00FF8B8E8A878B809292505050");
		...
		$placeholderTrainer8[3]["pokemon2"] = hex2bin("4449EEE97E5900000B1FA8D6D8D6D8C350D6D8C350DDED050A050A640000005A000001510151013A00DD00B500C200E68C80828A8E868D84949150");
		...
		$placeholderTrainer8[2]["class"] = hexdec("16");
		$placeholderTrainer8[2]["pokemon1"] = hex2bin("3B54F135F59C00000B1FA8C350AFC8C350AFC8D6D8DFDE050F050A640000005A000001500150011200E100F7010600E2809182808D888D50505050");
		$placeholderTrainer8[2]["pokemon2"] = hex2bin("F2924CF1877E00000B1FA8C350AFC8C350C350C350BDFE0A050A05640000005A000001A801A8005A005F00B400D60142818B889292849850505050");
		$placeholderTrainer8[2]["pokemon3"] = hex2bin("E50335F2F14C00000B1FA8C3509C40C350C350C350DBFE0F0F050A640000005A00000135013500EB00A400FC011500DF878E948D838E8E8C505050");
	...
	function getBattleTowerPlaceholderTrainerFR9($number) {
		...
		$placeholderTrainer9[6]["class"] = hexdec("24");
		$placeholderTrainer9[6]["pokemon1"] = hex2bin("E554F2352E9C00000F4240EA60EA60EA60EA60EA60FDED0F0F140A64000000640000015B015B011400C0011C013800FC878E948D838E8E8C505050");
		$placeholderTrainer9[6]["pokemon2"] = hex2bin("4449EE593FE900000F4240EA60EA60EA60EA60EA60FDEF050A050A6400000064000001790179016400FC00CC00E2010A8C80828A8E868D84949150");
		...
		$placeholderTrainer9[5]["pokemon2"] = hex2bin("80523F59E75500000F4240C350C350C350C350C350FDEF050A0F0F640000006400000155015501220114013400AA00E6938094918E925050505050");
		$placeholderTrainer9[5]["pokemon3"] = hex2bin("3B9235F5E73F00000F4240D6D8C350C350D6D8C350DDEF0F050F056400000064000001760176013200F60119012200FA809182808D888D50505050");
		...
		$placeholderTrainer9[4]["pokemon2"] = hex2bin("6503565599F300000F4240AFC8C350C350AFC8AFC8FBEF140F0514640000006400000135013500BE00DE016E00F800F8848B848293918E83845050");
		$placeholderTrainer9[4]["pokemon3"] = hex2bin("706D39593F9D00000F4240D6D8C350D6D8C350AFC8FDEF0F0A050A6400000064000001940194015E014900A800B200B29187888D8E8584918E9250");
		$placeholderTrainer9[4]["message_start"] = hex2bin("2503250D2C08020D");
		...
		$placeholderTrainer9[3]["pokemon3"] = hex2bin("C877C3D4DCF700000F4240AFC8C350D6D8C350D6D8BDEF0505140F640000006400000135013500CA00D1010201070107858494858E918495845050");
		...
		$placeholderTrainer9[2]["class"] = hexdec("27");
		$placeholderTrainer9[2]["pokemon1"] = hex2bin("D78CA33B8AB900000F4240C350C350BB80AFC8C350FDEF14050F1464000000640000012D012D011800C3013C00A000F08580918594918493505050");
